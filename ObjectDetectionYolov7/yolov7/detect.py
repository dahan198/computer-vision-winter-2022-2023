...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='arranged_dataset/train/images', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--iou-thres', type=float, default=0.0, help='IOU threshold for NMS')
